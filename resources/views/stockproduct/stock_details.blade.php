        ...
        <tr>
            ...
            <td>
              <div class="d-flex">
                ...
                <div class="container">
                <button data-id='{{$stock->id}}' data-quantity='{{$stock->quantity_rec}}' data-price='{{$stock->price}}' type="button" class="btn btn-primary" data-toggle="modal" data-target="#editModal">
                   edit
                  </button>  
                </div>
        ...
        <form  id="editForm" method="post">
          ...
          <div class="modal-body">
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="number" id="productquantity" class="form-control" name="quantity_rec" />
              </div>
            </div>
            <div class="form-group row">
              <label for="productprice"class="col-sm-4 col-form-label">product price</label>
              <div class="col-sm-4">
                <input type="number" id="productprice" class="form-control" name="price" />
              </div>
            </div>
          </div>
